...
def best5(file,question):
    ...
    lambda1 = 0.9 # lambda for the tf-idf written above
    lambda2 = 0.02 # lambda for the bm25 score from gensim bm25
...
2. when was Esperanto created?
    late 1970s cannot be recognized as NER in the tagger
3. How many countries used Esperanto?
    spelling error, and also the lambdas need to be tuned
